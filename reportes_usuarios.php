...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-lista--porcentaje">
        ...
        <div class="rdm-tarjeta--primario-largo">
            <h1 class="rdm-tarjeta--titulo-largo">Usuarios <?php echo ($rango); ?></h1>
        ...
        <?php
        //ventas por cada usuario
        $consulta = $conexion->query("SELECT count(usuario_id), usuario_id FROM ventas_datos WHERE local_id = '$sesion_local_id' and estado = 'liquidado' and fecha BETWEEN '$desde' and '$hasta' GROUP BY usuario_id ORDER BY count(usuario_id) DESC");                
        ...
        while ($fila = $consulta->fetch_assoc())
        {
            ...
            {
                $nombres = ucfirst($fila_usuario['nombres']);
                $apellidos = ucfirst($fila_usuario['apellidos']);
                $usuario = "$nombres $apellidos";
            }

            //consulto el total para cada usuario
            $consulta2 = $conexion->query("SELECT * FROM ventas_datos WHERE local_id = '$sesion_local_id' and estado = 'liquidado' and usuario_id = '$usuario_id' and fecha BETWEEN '$desde' and '$hasta'");
            ...
            <article class="rdm-lista--item-porcentaje">
                <div>
                    <div class="rdm-lista--izquierda-porcentaje">
                        <h2 class="rdm-lista--titulo-porcentaje"><?php echo ucfirst($usuario); ?></h2>
