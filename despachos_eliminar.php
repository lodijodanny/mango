...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-tarjeta">        
        ...
        <div class="rdm-tarjeta--acciones-izquierda">
            <a href="despachos_detalle.php?despacho_id=<?php echo "$despacho_id"; ?>"><button class="rdm-boton--plano">Cancelar</button></a>
            <a href="despachos_ver.php?eliminar=si&despacho_id=<?php echo "$despacho_id"; ?>"><button class="rdm-boton--plano-resaltado">Eliminar</button></a>
        </div>
