...
<body style="background: none;" onload="javascript:window.print(); loaded()">
...
<section class="rdm-factura--imprimira4">
            ...
            {   
                ...
                while ($fila_producto = $consulta_producto->fetch_assoc())
                {
                    ...
                    while ($fila_pro_dat = $consulta_pro_dat->fetch_assoc())
                    {
                        ...
                        $descripcion = $fila_pro_dat['descripcion'];
    ...
    $impuesto_valor_total = $total_con_descuento_mas_impuesto;
                ...
                <div class="rdm-factura--textoa4"><?php echo ucfirst("$categoria"); ?></div>
        ...
        <div class="rdm-factura--contenedor-fijoa4" style="position: fixed; bottom: 2em; width: 100%; z-index: 20001;">
