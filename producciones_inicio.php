...
<header class="rdm-toolbar--contenedor">
    <div class="rdm-toolbar--fila">
        <div class="rdm-toolbar--izquierda">
            ...
            <h2 class="rdm-toolbar--titulo">Producciones</h2>
        </div>
    </div>
</header>
...
<main class="rdm--contenedor-toolbar">
    ...
    <h2 class="rdm-lista--titulo-largo">¿Qué deseas producir?</h2>
            ...
            <article class="rdm-lista--item-sencillo">
                <div class="rdm-lista--izquierda">
                    ...
                    <div class="rdm-lista--contenedor">
                        ...
                        <h2 class="rdm-lista--texto-secundario">Componentes hechos con materia prima</h2>
                    </div>
                </div>
            ...
            <article class="rdm-lista--item-sencillo">
                <div class="rdm-lista--izquierda">
                    ...
                    <div class="rdm-lista--contenedor">
                        ...
                        <h2 class="rdm-lista--texto-secundario">Productos finales</h2>
                    </div>
                </div>
