        ...
        while ($fila = $consulta->fetch_assoc())
        {
            ...
            <section class="rdm-tarjeta">
                ...
                <div class="rdm-tarjeta--primario-largo">
                    <h1 class="rdm-tarjeta--titulo-largo">$ <?php echo number_format($costo_unidad, 2, ",", "."); ?> x <?php echo safe_ucfirst("$unidad"); ?></h1>
                    <h2 class="rdm-tarjeta--subtitulo-largo"><?php echo safe_ucfirst($proveedor) ?></h2>                </div>
