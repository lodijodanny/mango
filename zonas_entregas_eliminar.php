...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-tarjeta">        
        ...
        <div class="rdm-tarjeta--acciones-izquierda">
            <a href="zonas_entregas_editar.php?id=<?php echo "$id"; ?>&zona=<?php echo "$zona"; ?>"><button class="rdm-boton--plano">Cancelar</button></a>
            <a href="zonas_entregas_ver.php?eliminar=si&id=<?php echo "$id"; ?>&zona=<?php echo "$zona"; ?>"><button class="rdm-boton--plano-resaltado">Eliminar</button></a>
        </div>
