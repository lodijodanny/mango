...
if ($recibir == 'si')
{
    ...
    if ($consulta_inventario->num_rows == 0)
    {
        ...
        $operacion = "suma";
        $motivo = "primer despacho";
        $descripcion = "despacho No $despacho_id"; 
    }
    else
    {
    ...
    $actualizo_componente = $conexion->query("UPDATE despachos_componentes SET estado = 'recibido' WHERE id = '$despacho_componente_id'");
...
<main class="rdm--contenedor-toolbar">    
    ...
    if ($consulta->num_rows == 0)
    {
        ...
        $actualizo_despacho = $conexion->query("UPDATE despachos SET fecha_recibe = '$ahora', estado = 'recibido', usuario_recibe = '$sesion_id' WHERE id = '$despacho_id'");
        ...
        while ($fila = $consulta->fetch_assoc()) 
        {
            ...
            <article class="rdm-lista--item-sencillo">
                ...
                <div class="rdm-lista--derecha">
                    <a href="inventario_recibir.php?recibir=si&despacho_componente_id=<?php echo "$despacho_componente_id";?>&componente_id=<?php echo "$componente_id";?>&componente=<?php echo "$componente";?>&unidad=<?php echo "$unidad";?>&cantidad=<?php echo "$cantidadx";?>&despacho_id=<?php echo "$despacho_id";?>"><div class="rdm-lista--icono"><i class="zmdi zmdi-check zmdi-hc-2x"></i></div></a>
                </div>
            </article>
