...
$ano_desde = isset($_POST['ano_desde']) ? $_POST['ano_desde'] : null ;
$mes_desde = isset($_POST['mes_desde']) ? $_POST['mes_desde'] : null ;
$dia_desde = isset($_POST['dia_desde']) ? $_POST['dia_desde'] : null ;
$hora_desde = isset($_POST['hora_desde']) ? $_POST['hora_desde'] : null ;

$ano_hasta = isset($_POST['ano_hasta']) ? $_POST['ano_hasta'] : null ;
$mes_hasta = isset($_POST['mes_hasta']) ? $_POST['mes_hasta'] : null ;
$dia_hasta = isset($_POST['dia_hasta']) ? $_POST['dia_hasta'] : null ;
$hora_hasta = isset($_POST['hora_hasta']) ? $_POST['hora_hasta'] : null ;
    ...
    <section id="contenedor">
        ...
        <article class="bloque">
            ...
            <div class="bloque_margen">
                ...
                <p>
                    <a href="reportes_contador_ventas.php?rango=hoy"><input type="button" class="boton_reporte" value="Hoy"></a>
                    <a href="reportes_contador_ventas.php?rango=semana"><input type="button" class="boton_reporte" value="Esta semana"></a>
                    <a href="reportes_contador_ventas.php?rango=mes"><input type="button" class="boton_reporte" value="Este mes"></a>
                </p> 
        ...
        <article class="bloque">
            <div class="bloque_margen">
                ...
                $consulta_ventas_hoy = $conexion->query("SELECT * FROM ventas_datos WHERE fecha BETWEEN '$fecha_inicio_hoy' and '$fecha_fin_hoy'");
                $total_ventas = $consulta_ventas_hoy->num_rows;
                ?>

                <?php
                //ventas por cada local
                $consulta = $conexion->query("SELECT count(local_id), local_id FROM ventas_datos WHERE fecha BETWEEN '$fecha_inicio_hoy' and '$fecha_fin_hoy' GROUP BY local_id ORDER BY count(local_id) DESC");                
                ...
                while ($fila = $consulta->fetch_assoc())
                {
                    ...
                    //consulto el local
                    $consulta2 = $conexion->query("SELECT * FROM locales WHERE id = $local_id");
                    ...
                    $consulta2 = $conexion->query("SELECT * FROM ventas_datos WHERE local_id = '$local_id' and fecha BETWEEN '$fecha_inicio_hoy' and '$fecha_fin_hoy'");
                    $total_local = $consulta2->num_rows;
                    

                    $porcentaje_local = ($total_local / $total_ventas) * 100;
                    ...
                    <p class="texto_porcentaje">
                        ...
                        <span class="porcentaje_der"><?php echo "$total_local"; ?></span>
                    </p>
