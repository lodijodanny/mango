...
if ($agregar == 'si')
{
    ...
    if ($fila = $consulta->fetch_assoc())
    {
        ...
        $mensaje = "Despacho ya existe y no ha sido enviado";
        ...
        while ($fila = $consulta->fetch_assoc()) 
        {
            ...
            <article class="rdm-lista--item-sencillo">
                ...
                <div class="rdm-lista--derecha">
                    <a href="despachos_detalle.php?agregar_despacho=si&destino=<?php echo "$id"; ?>"><div class="rdm-lista--icono"><i class="zmdi zmdi-arrow-right zmdi-hc-2x"></i></div></a>
                </div>
            </article>
