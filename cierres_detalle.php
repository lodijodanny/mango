...
<main class="rdm--contenedor-toolbar">
    ...
    <?php
    //consulto y muestro el cierre
    $consulta = $conexion->query("SELECT * FROM cierres_datos WHERE id = '$id'");
    ...
    if ($consulta->num_rows == 0)
    {
        ...
        <div class="rdm-vacio--caja">
            ...
            <p class="rdm-tipografia--subtitulo1">Esta cierre ya no existe</p>
        </div>
        ...
        while ($fila = $consulta->fetch_assoc())
        {
            ...
            <section class="rdm-tarjeta">
                ...
                <div class="rdm-tarjeta--primario-largo">
                    <h1 class="rdm-tarjeta--titulo-largo">$ <?php echo number_format($cierre, 2, ",", "."); ?></h1>
                ...
                <div class="rdm-tarjeta--cuerpo">
                    ...
                    $consulta_denominaciones = $conexion->query("SELECT * FROM cierres_denominaciones WHERE cierre_id = '$cierre_id' ORDER BY denominacion DESC");
...
<footer>
    ...
    <a href="cierres_denominaciones.php?cierre_id=<?php echo "$id"; ?>"><button class="rdm-boton--fab" ><i class="zmdi zmdi-edit zmdi-hc-2x"></i></button></a>
