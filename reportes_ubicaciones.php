...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-lista--porcentaje">
        ...
        <div class="rdm-tarjeta--primario-largo">
            <h1 class="rdm-tarjeta--titulo-largo">Ubicaciones <?php echo ($rango); ?></h1>
        ...
        <?php
        //ventas por cada ubicacion
        $consulta = $conexion->query("SELECT count(ubicacion_id), ubicacion_id FROM ventas_datos WHERE local_id = '$sesion_local_id' and estado = 'liquidado' and fecha BETWEEN '$desde' and '$hasta' GROUP BY ubicacion_id ORDER BY count(ubicacion_id) DESC");                
        ...
        while ($fila = $consulta->fetch_assoc())
        {
            ...
            $consulta2 = $conexion->query("SELECT * FROM ventas_datos WHERE local_id = '$sesion_local_id' and estado = 'liquidado' and ubicacion_id = '$ubicacion_id' and fecha BETWEEN '$desde' and '$hasta'");
            ...
            <article class="rdm-lista--item-porcentaje">
                <div>
                    <div class="rdm-lista--izquierda-porcentaje">
                        <h2 class="rdm-lista--titulo-porcentaje"><?php echo ucfirst($ubicacion); ?></h2>
