...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-lista--porcentaje">
        ...
        <div class="rdm-tarjeta--primario-largo">
            ...
            $consulta_ingresos = $conexion->query("SELECT * FROM ventas_datos WHERE fecha BETWEEN '$desde' and '$hasta' and estado = 'liquidado' and tipo_pago = 'efectivo'");
            ...
            <?php 
            //reasignacion de variables
            $efectivo_total_real = $neto_total;
            ...
            <?php
            //ingresos en otro tipos de pago
            $consulta_ingresos = $conexion->query("SELECT * FROM ventas_datos WHERE fecha BETWEEN '$desde' and '$hasta' and estado = 'liquidado' and tipo_pago != 'efectivo'");
            ...
            <?php 
            //total cierre
            $total_cierre_real = $total_base_hoy + $efectivo_total_real + $otros_total_real - $total_gastos_hoy;
            ?>
            ...
            <p class="rdm-tarjeta--titulo-largo"><b>Base: </b>$<?php echo number_format($total_base_hoy, 0, ",", ".");?></p>
            <p class="rdm-tarjeta--titulo-largo"><b>Ventas efectivo: </b>$<?php echo number_format($efectivo_total_real, 0, ",", ".");?></p>
            <p class="rdm-tarjeta--titulo-largo"><b>Ventas otros: </b>$<?php echo number_format($otros_total_real, 0, ",", ".");?></p>
            <p class="rdm-tarjeta--titulo-largo" style="color: #F44336;"><b>Gastos: </b>- $<?php echo number_format($total_gastos_hoy, 0, ",", ".");?></p>

            
            --
            <p class="rdm-tarjeta--titulo-largo"><b>Total cierre: </b>$<?php echo number_format($total_cierre_real, 0, ",", ".");?></p>
        </div>
