            ...
            <a href="ubicaciones_detalle.php?id=<?php echo "$id"; ?>&ubicacion=<?php echo "$ubicacion"; ?>">
                ...
                <article class="rdm-lista--item-sencillo">
                    ...
                    <div class="rdm-lista--izquierda">
                        ...
                        <div class="rdm-lista--contenedor">
                            <h2 class="rdm-lista--titulo"><?php echo preg_replace("/$consultaBusqueda/i", "<span class='rdm-resaltado'>\$0</span>", safe_ucfirst($ubicacion)); ?></h2>
                            ...
                            <h2 class="rdm-lista--texto-secundario"><?php echo preg_replace("/$consultaBusqueda/i", "<span class='rdm-resaltado'>\$0</span>", "Ubicada en " . safe_ucfirst($ubicada)); ?></h2>
                        </div>
                    </div>
