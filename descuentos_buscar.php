...
{	
    ...
    $consulta = mysqli_query($conexion, "SELECT * FROM descuentos WHERE descuento LIKE '%$consultaBusqueda%' or porcentaje LIKE '%$consultaBusqueda%' ORDER BY descuento LIMIT 10");
            ...
            <a href="descuentos_detalle.php?id=<?php echo "$id"; ?>&descuento=<?php echo "$descuento"; ?>">
                ...
                <article class="rdm-lista--item-sencillo">
                    ...
                    <div class="rdm-lista--izquierda-sencillo">
                        ...
                        <div class="rdm-lista--contenedor">
                            <h2 class="rdm-lista--titulo"><?php echo preg_replace("/$consultaBusqueda/i", "<span class='rdm-resaltado'>\$0</span>", safe_ucfirst($descuento)); ?></h2>
...
?>
<h2 class="rdm-lista--titulo-largo">Descuentos agregados</h2>