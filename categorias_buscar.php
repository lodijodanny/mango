            ...
            <a href="categorias_detalle.php?id=<?php echo "$id"; ?>&categoria=<?php echo "$categoria"; ?>">
                ...
                <article class="rdm-lista--item-sencillo">
                    ...
                    <div class="rdm-lista--izquierda-sencillo">
                        ...
                        <div class="rdm-lista--contenedor">
                            <h2 class="rdm-lista--titulo"><?php echo preg_replace("/$consultaBusqueda/i", "<span class='rdm-resaltado'>\$0</span>", safe_ucfirst($categoria)); ?></h2>
                            <h2 class="rdm-lista--texto-secundario"><?php echo preg_replace("/$consultaBusqueda/i", "<span class='rdm-resaltado'>\$0</span>", safe_ucfirst($total_productos)); ?> productos relacionados</h2>
                        </div>
                    </div>
