...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-tarjeta">
        ...
        <div class="rdm-tarjeta--acciones-izquierda">
            <a href="productos_editar.php?id=<?php echo "$id"; ?>&producto=<?php echo "$producto"; ?>"><button class="rdm-boton--tonal">Cancelar</button></a>
            <a href="productos_ver.php?eliminar=si&id=<?php echo "$id"; ?>&producto=<?php echo "$producto"; ?>"><button class="rdm-boton--text">Eliminar</button></a>
        </div>
