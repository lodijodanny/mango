...
<main class="rdm--contenedor-toolbar">
    ...
    <section class="rdm-tarjeta">        
        ...
        <div class="rdm-tarjeta--acciones-izquierda">
            <a href="descuentos_editar.php?id=<?php echo "$id"; ?>&descuento=<?php echo "$descuento"; ?>"><button class="rdm-boton--plano">Cancelar</button></a>
            <a href="descuentos_ver.php?eliminar=si&id=<?php echo "$id"; ?>&descuento=<?php echo "$descuento"; ?>"><button class="rdm-boton--plano-resaltado">Eliminar</button></a>
        </div>
