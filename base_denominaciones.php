...
if(isset($_POST['guardar'])) $guardar = $_POST['guardar']; elseif(isset($_GET['guardar'])) $guardar = $_GET['guardar']; else $guardar = null;
                ...
                <div class="rdm-lista--izquierda">
                    ...
                    <div class="rdm-lista--contenedor">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>#<?php echo $producto_id; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <a href="ventas_productos.php?eliminar=si&producto_venta_id=<?php echo "$producto_venta_id";?>&producto=<?php echo "$producto";?>&venta_id=<?php echo "$venta_id";?>&categoria=<?php echo "$categoria";?>&categoria_id=<?php echo "$categoria_id";?>#<?php echo $producto_id; ?>"><button type="button" class="rdm-boton--filled"><i class="zmdi zmdi-delete"></i> x 1</button></a>
